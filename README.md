...
A.- Arduino: (https://github.com/roboticsuantof/open_SCADA_based_on_Arduino/tree/main/Arduino%20NRF24L01%20-%20Comunicacion%20Inalambrica, branch: Main)
B.- Xampp: (https://github.com/roboticsuantof/open_SCADA_based_on_Arduino/tree/main/Htdocs%20in%20Arduino, branch: Main)

# Configuraciones

1.0. Descargar e instalar programa de Arduino IDE.
2.0. Abrir los archivos descargados (A) e insertar variables a medir.
...
2.2. Abrir los archivos descargados (B) e insertar variables para que sean recibidas por la estación de monitoreo.
